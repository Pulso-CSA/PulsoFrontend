#━━━━━━━━━━━━━━❮◆❯━━━━━━━━━━━━━━
#━━━━━━━━━❮Sistema de Compreensão JavaScript❯━━━━━━━━━
#━━━━━━━━━━━━━━❮◆❯━━━━━━━━━━━━━━
...
class ComprehensionJSRequest(BaseModel):
    """Payload da entrada principal do workflow JavaScript (Sistema de Compreensão)."""
    ...
    # Campos específicos para JavaScript
    use_python: Optional[bool] = Field(
        default=False,
        description="Se True, usa Python para o projeto.",
    )
    use_javascript: Optional[bool] = Field(
        default=False,
        description="Se True, usa JavaScript para o projeto.",
    )
    use_typescript: Optional[bool] = Field(
        default=False,
        description="Se True e use_javascript=True, usa TypeScript.",
    )
    use_react: Optional[bool] = Field(
        default=False,
        description="Se True e use_javascript=True, usa React.",
    )
    use_vue: Optional[bool] = Field(
        default=False,
        description="Se True e use_javascript=True, usa Vue.js.",
    )
    use_angular: Optional[bool] = Field(
        default=False,
        description="Se True e use_javascript=True, usa Angular.",
    )
...
class ComprehensionJSResponse(BaseModel):
    """
    Resposta do Sistema de Compreensão JavaScript.
    ...
    language: Optional[str] = Field(
        default=None,
        description="Linguagem detectada: python, javascript, typescript, react.",
    )
    framework: Optional[str] = Field(
        default=None,
        description="Framework detectado: react, typescript, ou ambos.",
    )
