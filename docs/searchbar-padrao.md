# Elemento 21 - Barra de Busca Padrão (Cosmic)

## O que é
Barra de busca padrão do app com tema cósmico. Efeitos de nebulosa, poeira cósmica, campo de estrelas e anel cósmico que animam no hover e focus. Ícone de lupa à esquerda e ícone de wormhole à direita. Placeholder "Explore the cosmos...". Bordas em gradiente conic que rotacionam suavemente.
...
## CSS
Arquivo: `css/components/searchbar-padrao.css` (classes: `.galaxy`, `#search-container`, `.nebula`, `.starfield`, `.cosmic-dust`, `.stardust`, `.cosmic-ring`, `.input`, `#main`, `#wormhole-icon`, `#search-icon`, `.wormhole-border`)
...
## Uso no app
Esta é a **barra de busca padrão** a ser utilizada em todo o aplicativo Pulso. Substitua placeholders conforme o contexto (ex.: "Buscar conversas...", "Pesquisar...", "Explore the cosmos...").
