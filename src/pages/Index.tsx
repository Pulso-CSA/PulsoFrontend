  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden relative flex flex-col">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-finops/10 rounded-full blur-[100px] animate-pulse stagger-3" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-dataAi/8 rounded-full blur-[80px] animate-pulse stagger-5" />
