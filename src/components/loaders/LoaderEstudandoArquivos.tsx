/**
 * Loader 4 — "estudando seus arquivos"
 * Uiverse documents (Nawsome) — livro com páginas virando
 */
import { cn } from "@/lib/utils";

export interface LoaderEstudandoArquivosProps {
  className?: string;
  message?: string;
  compact?: boolean;
}
...
export function LoaderEstudandoArquivos({
  className,
